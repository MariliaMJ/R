...
library(reshape2)
#load data
s_fname <- "/home/erikomorais/marilia/R/prosperLoanData.csv"
d <- read.csv(s_fname)
```
...
ggplot(data=d,aes(ListingCategory..numeric.)) + 
...
```{r, fig.width = 10}
CreditScoreCount <- qplot(x = CreditScoreRangeLower, data = d, binwidth = 20,
